...
export default function TouchActionButton({
  ...
  const variantStyles = {
    ...
    secondary:
      'bg-slate-900/90 text-slate-200 border border-slate-800 hover:bg-slate-800 shadow-md backdrop-blur-xl',
    danger:
    ...
    ghost:
      'bg-transparent text-slate-400 hover:text-slate-100 hover:bg-slate-800/50 border border-transparent',
  };
